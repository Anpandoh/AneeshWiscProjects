...
80100044:	bb 54 a6 10 80       	mov    $0x8010a654,%ebx
{
80100049:	83 ec 0c             	sub    $0xc,%esp
  initlock(&bcache.lock, "bcache");
8010004c:	68 40 73 10 80       	push   $0x80107340
80100051:	68 20 a6 10 80       	push   $0x8010a620
80100056:	e8 75 43 00 00       	call   801043d0 <initlock>
  bcache.head.next = &bcache.head;
8010005b:	83 c4 10             	add    $0x10,%esp
8010005e:	b8 1c ed 10 80       	mov    $0x8010ed1c,%eax
  bcache.head.prev = &bcache.head;
80100063:	c7 05 6c ed 10 80 1c 	movl   $0x8010ed1c,0x8010ed6c
8010006a:	ed 10 80 
  bcache.head.next = &bcache.head;
8010006d:	c7 05 70 ed 10 80 1c 	movl   $0x8010ed1c,0x8010ed70
80100074:	ed 10 80 
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
...
801000b0:	89 1d 70 ed 10 80    	mov    %ebx,0x8010ed70
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
801000b6:	81 fb c0 ea 10 80    	cmp    $0x8010eac0,%ebx
...
801000dc:	8b 7d 0c             	mov    0xc(%ebp),%edi
  acquire(&bcache.lock);
801000df:	68 20 a6 10 80       	push   $0x8010a620
801000e4:	e8 b7 44 00 00       	call   801045a0 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
801000e9:	8b 1d 70 ed 10 80    	mov    0x8010ed70,%ebx
801000ef:	83 c4 10             	add    $0x10,%esp
801000f2:	81 fb 1c ed 10 80    	cmp    $0x8010ed1c,%ebx
801000f8:	75 11                	jne    8010010b <bread+0x3b>
801000fa:	eb 24                	jmp    80100120 <bread+0x50>
801000fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80100100:	8b 5b 54             	mov    0x54(%ebx),%ebx
80100103:	81 fb 1c ed 10 80    	cmp    $0x8010ed1c,%ebx
...
80100120:	8b 1d 6c ed 10 80    	mov    0x8010ed6c,%ebx
80100126:	81 fb 1c ed 10 80    	cmp    $0x8010ed1c,%ebx
8010012c:	75 0d                	jne    8010013b <bread+0x6b>
8010012e:	eb 6e                	jmp    8010019e <bread+0xce>
80100130:	8b 5b 50             	mov    0x50(%ebx),%ebx
80100133:	81 fb 1c ed 10 80    	cmp    $0x8010ed1c,%ebx
...
8010015d:	68 20 a6 10 80       	push   $0x8010a620
...
8010020f:	e8 2c 41 00 00       	call   80104340 <releasesleep>
  ...
  acquire(&bcache.lock);
80100214:	c7 04 24 20 a6 10 80 	movl   $0x8010a620,(%esp)
...
8010023f:	89 50 54             	mov    %edx,0x54(%eax)
    b->next = bcache.head.next;
80100242:	a1 70 ed 10 80       	mov    0x8010ed70,%eax
    b->prev = &bcache.head;
80100247:	c7 43 50 1c ed 10 80 	movl   $0x8010ed1c,0x50(%ebx)
    b->next = bcache.head.next;
8010024e:	89 43 54             	mov    %eax,0x54(%ebx)
    bcache.head.next->prev = b;
80100251:	a1 70 ed 10 80       	mov    0x8010ed70,%eax
80100256:	89 58 50             	mov    %ebx,0x50(%eax)
    bcache.head.next = b;
80100259:	89 1d 70 ed 10 80    	mov    %ebx,0x8010ed70
  }
  
  release(&bcache.lock);
8010025f:	c7 45 08 20 a6 10 80 	movl   $0x8010a620,0x8(%ebp)
}
...
80100294:	e8 c7 15 00 00       	call   80101860 <iunlock>
  acquire(&cons.lock);
80100299:	c7 04 24 20 f0 10 80 	movl   $0x8010f020,(%esp)
...
801002b0:	a1 00 f0 10 80       	mov    0x8010f000,%eax
801002b5:	3b 05 04 f0 10 80    	cmp    0x8010f004,%eax
...
801002c3:	68 20 f0 10 80       	push   $0x8010f020
801002c8:	68 00 f0 10 80       	push   $0x8010f000
801002cd:	e8 6e 3d 00 00       	call   80104040 <sleep>
    while(input.r == input.w){
801002d2:	a1 00 f0 10 80       	mov    0x8010f000,%eax
801002d7:	83 c4 10             	add    $0x10,%esp
801002da:	3b 05 04 f0 10 80    	cmp    0x8010f004,%eax
...
801002f1:	68 20 f0 10 80       	push   $0x8010f020
...
8010031b:	89 15 00 f0 10 80    	mov    %edx,0x8010f000
80100321:	89 c2                	mov    %eax,%edx
80100323:	83 e2 7f             	and    $0x7f,%edx
80100326:	0f be 8a 80 ef 10 80 	movsbl -0x7fef1080(%edx),%ecx
    if(c == C('D')){  // EOF
...
80100347:	68 20 f0 10 80       	push   $0x8010f020
...
8010036b:	73 d7                	jae    80100344 <consoleread+0xc4>
        input.r--;
8010036d:	a3 00 f0 10 80       	mov    %eax,0x8010f000
...
80100388:	fa                   	cli    
  cons.locking = 0;
80100389:	c7 05 54 f0 10 80 00 	movl   $0x0,0x8010f054
80100390:	00 00 00 
  getcallerpcs(&s, pcs);
...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 c3 7c 10 80 	movl   $0x80107cc3,(%esp)
...
801003e9:	c7 05 58 f0 10 80 01 	movl   $0x1,0x8010f058
801003f0:	00 00 00 
  for(;;)
...
8010059f:	e8 bc 12 00 00       	call   80101860 <iunlock>
  acquire(&cons.lock);
801005a4:	c7 04 24 20 f0 10 80 	movl   $0x8010f020,(%esp)
...
801005ba:	8d 3c 33             	lea    (%ebx,%esi,1),%edi
  if(panicked){
801005bd:	8b 15 58 f0 10 80    	mov    0x8010f058,%edx
    consputc(buf[i] & 0xff);
...
801005df:	68 20 f0 10 80       	push   $0x8010f020
...
8010065f:	0f be c2             	movsbl %dl,%eax
  if(panicked){
80100662:	8b 15 58 f0 10 80    	mov    0x8010f058,%edx
...
801006a9:	a1 54 f0 10 80       	mov    0x8010f054,%eax
...
8010075a:	0f 84 08 01 00 00    	je     80100868 <cprintf+0x1c8>
  if(panicked){
80100760:	8b 15 58 f0 10 80    	mov    0x8010f058,%edx
...
801007a5:	8d 76 00             	lea    0x0(%esi),%esi
  if(panicked){
801007a8:	8b 0d 58 f0 10 80    	mov    0x8010f058,%ecx
...
801007b5:	8d 76 00             	lea    0x0(%esi),%esi
  if(panicked){
801007b8:	a1 58 f0 10 80       	mov    0x8010f058,%eax
...
801007e3:	68 20 f0 10 80       	push   $0x8010f020
801007e8:	e8 b3 3d 00 00       	call   801045a0 <acquire>
801007ed:	83 c4 10             	add    $0x10,%esp
801007f0:	e9 c4 fe ff ff       	jmp    801006b9 <cprintf+0x19>
  if(panicked){
801007f5:	8b 0d 58 f0 10 80    	mov    0x8010f058,%ecx
801007fb:	85 c9                	test   %ecx,%ecx
801007fd:	75 31                	jne    80100830 <cprintf+0x190>
801007ff:	b8 25 00 00 00       	mov    $0x25,%eax
80100804:	89 55 e0             	mov    %edx,-0x20(%ebp)
80100807:	e8 f4 fb ff ff       	call   80100400 <consputc.part.0>
8010080c:	8b 15 58 f0 10 80    	mov    0x8010f058,%edx
...
80100856:	68 20 f0 10 80       	push   $0x8010f020
...
8010088b:	8b 7d 08             	mov    0x8(%ebp),%edi
  acquire(&cons.lock);
8010088e:	68 20 f0 10 80       	push   $0x8010f020
...
801008d3:	a1 08 f0 10 80       	mov    0x8010f008,%eax
801008d8:	89 c2                	mov    %eax,%edx
801008da:	2b 15 00 f0 10 80    	sub    0x8010f000,%edx
801008e0:	83 fa 7f             	cmp    $0x7f,%edx
801008e3:	77 d2                	ja     801008b7 <consoleintr+0x37>
        input.buf[input.e++ % INPUT_BUF] = c;
801008e5:	8d 48 01             	lea    0x1(%eax),%ecx
  if(panicked){
801008e8:	8b 15 58 f0 10 80    	mov    0x8010f058,%edx
        input.buf[input.e++ % INPUT_BUF] = c;
801008ee:	83 e0 7f             	and    $0x7f,%eax
801008f1:	89 0d 08 f0 10 80    	mov    %ecx,0x8010f008
        c = (c == '\r') ? '\n' : c;
801008f7:	83 fb 0d             	cmp    $0xd,%ebx
801008fa:	0f 84 13 01 00 00    	je     80100a13 <consoleintr+0x193>
        input.buf[input.e++ % INPUT_BUF] = c;
80100900:	88 98 80 ef 10 80    	mov    %bl,-0x7fef1080(%eax)
  if(panicked){
...
80100927:	a1 00 f0 10 80       	mov    0x8010f000,%eax
8010092c:	83 e8 80             	sub    $0xffffff80,%eax
8010092f:	39 05 08 f0 10 80    	cmp    %eax,0x8010f008
80100935:	75 80                	jne    801008b7 <consoleintr+0x37>
80100937:	e9 fb 00 00 00       	jmp    80100a37 <consoleintr+0x1b7>
8010093c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      while(input.e != input.w &&
80100940:	a1 08 f0 10 80       	mov    0x8010f008,%eax
80100945:	39 05 04 f0 10 80    	cmp    %eax,0x8010f004
...
80100956:	83 e2 7f             	and    $0x7f,%edx
      while(input.e != input.w &&
80100959:	80 ba 80 ef 10 80 0a 	cmpb   $0xa,-0x7fef1080(%edx)
80100960:	0f 84 51 ff ff ff    	je     801008b7 <consoleintr+0x37>
  if(panicked){
80100966:	8b 15 58 f0 10 80    	mov    0x8010f058,%edx
        input.e--;
8010096c:	a3 08 f0 10 80       	mov    %eax,0x8010f008
  if(panicked){
...
8010097f:	90                   	nop
      if(input.e != input.w){
80100980:	a1 08 f0 10 80       	mov    0x8010f008,%eax
80100985:	3b 05 04 f0 10 80    	cmp    0x8010f004,%eax
8010098b:	0f 84 26 ff ff ff    	je     801008b7 <consoleintr+0x37>
        input.e--;
80100991:	83 e8 01             	sub    $0x1,%eax
80100994:	a3 08 f0 10 80       	mov    %eax,0x8010f008
  if(panicked){
80100999:	a1 58 f0 10 80       	mov    0x8010f058,%eax
...
801009ad:	e8 4e fa ff ff       	call   80100400 <consputc.part.0>
      while(input.e != input.w &&
801009b2:	a1 08 f0 10 80       	mov    0x8010f008,%eax
801009b7:	3b 05 04 f0 10 80    	cmp    0x8010f004,%eax
801009bd:	75 92                	jne    80100951 <consoleintr+0xd1>
801009bf:	e9 f3 fe ff ff       	jmp    801008b7 <consoleintr+0x37>
801009c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&cons.lock);
801009c8:	83 ec 0c             	sub    $0xc,%esp
801009cb:	68 20 f0 10 80       	push   $0x8010f020
...
80100a0e:	e9 cd 37 00 00       	jmp    801041e0 <procdump>
        input.buf[input.e++ % INPUT_BUF] = c;
80100a13:	c6 80 80 ef 10 80 0a 	movb   $0xa,-0x7fef1080(%eax)
  if(panicked){
...
80100a2d:	e8 ce f9 ff ff       	call   80100400 <consputc.part.0>
          input.w = input.e;
80100a32:	a1 08 f0 10 80       	mov    0x8010f008,%eax
          wakeup(&input.r);
80100a37:	83 ec 0c             	sub    $0xc,%esp
          input.w = input.e;
80100a3a:	a3 04 f0 10 80       	mov    %eax,0x8010f004
          wakeup(&input.r);
80100a3f:	68 00 f0 10 80       	push   $0x8010f000
...
80100a6b:	68 20 f0 10 80       	push   $0x8010f020
...
80100a79:	6a 01                	push   $0x1
  devsw[CONSOLE].write = consolewrite;
80100a7b:	c7 05 0c fa 10 80 90 	movl   $0x80100590,0x8010fa0c
80100a82:	05 10 80 
  devsw[CONSOLE].read = consoleread;
80100a85:	c7 05 08 fa 10 80 80 	movl   $0x80100280,0x8010fa08
80100a8c:	02 10 80 
  cons.locking = 1;
80100a8f:	c7 05 54 f0 10 80 01 	movl   $0x1,0x8010f054
80100a96:	00 00 00 
  ioapicenable(IRQ_KBD, 0);
...
80100e1b:	68 60 f0 10 80       	push   $0x8010f060
...
80100e34:	bb 94 f0 10 80       	mov    $0x8010f094,%ebx
{
80100e39:	83 ec 10             	sub    $0x10,%esp
  acquire(&ftable.lock);
80100e3c:	68 60 f0 10 80       	push   $0x8010f060
...
80100e53:	81 fb f4 f9 10 80    	cmp    $0x8010f9f4,%ebx
...
80100e65:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      release(&ftable.lock);
80100e6c:	68 60 f0 10 80       	push   $0x8010f060
...
80100e83:	31 db                	xor    %ebx,%ebx
  release(&ftable.lock);
80100e85:	68 60 f0 10 80       	push   $0x8010f060
...
80100ea7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ftable.lock);
80100eaa:	68 60 f0 10 80       	push   $0x8010f060
...
80100ec4:	89 43 04             	mov    %eax,0x4(%ebx)
  release(&ftable.lock);
80100ec7:	68 60 f0 10 80       	push   $0x8010f060
...
80100ef9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ftable.lock);
80100efc:	68 60 f0 10 80       	push   $0x8010f060
...
80100f31:	8b 43 10             	mov    0x10(%ebx),%eax
  release(&ftable.lock);
80100f34:	68 60 f0 10 80       	push   $0x8010f060
  ff = *f;
...
80100f5d:	8d 76 00             	lea    0x0(%esi),%esi
    release(&ftable.lock);
80100f60:	c7 45 08 60 f0 10 80 	movl   $0x8010f060,0x8(%ebp)
}
...
801011c8:	03 05 cc 16 11 80    	add    0x801116cc,%eax
{
...
80101249:	8b 0d b4 16 11 80    	mov    0x801116b4,%ecx
{
...
8010126c:	03 05 cc 16 11 80    	add    0x801116cc,%eax
...
80101281:	a1 b4 16 11 80       	mov    0x801116b4,%eax
...
801012d9:	39 05 b4 16 11 80    	cmp    %eax,0x801116b4
...
8010135a:	bb 94 fa 10 80       	mov    $0x8010fa94,%ebx
{
8010135f:	83 ec 28             	sub    $0x28,%esp
80101362:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
80101365:	68 60 fa 10 80       	push   $0x8010fa60
...
8010138a:	81 fb b4 16 11 80    	cmp    $0x801116b4,%ebx
...
801013a9:	81 fb b4 16 11 80    	cmp    $0x801116b4,%ebx
...
801013cb:	c7 46 4c 00 00 00 00 	movl   $0x0,0x4c(%esi)
  release(&icache.lock);
801013d2:	68 60 fa 10 80       	push   $0x8010fa60
...
801013fb:	89 de                	mov    %ebx,%esi
      release(&icache.lock);
801013fd:	68 60 fa 10 80       	push   $0x8010fa60
      ip->ref++;
...
8010141d:	81 fb b4 16 11 80    	cmp    $0x801116b4,%ebx
...
80101564:	bb a0 fa 10 80       	mov    $0x8010faa0,%ebx
80101569:	83 ec 0c             	sub    $0xc,%esp
  initlock(&icache.lock, "icache");
8010156c:	68 4b 74 10 80       	push   $0x8010744b
80101571:	68 60 fa 10 80       	push   $0x8010fa60
...
80101597:	81 fb c0 16 11 80    	cmp    $0x801116c0,%ebx
...
801015b7:	68 b4 16 11 80       	push   $0x801116b4
801015bc:	e8 3f 31 00 00       	call   80104700 <memmove>
  brelse(bp);
801015c1:	89 1c 24             	mov    %ebx,(%esp)
801015c4:	e8 27 ec ff ff       	call   801001f0 <brelse>
  cprintf("sb: size %d nblocks %d ninodes %d nlog %d logstart %d\
801015c9:	ff 35 cc 16 11 80    	push   0x801116cc
801015cf:	ff 35 c8 16 11 80    	push   0x801116c8
801015d5:	ff 35 c4 16 11 80    	push   0x801116c4
801015db:	ff 35 c0 16 11 80    	push   0x801116c0
801015e1:	ff 35 bc 16 11 80    	push   0x801116bc
801015e7:	ff 35 b8 16 11 80    	push   0x801116b8
801015ed:	ff 35 b4 16 11 80    	push   0x801116b4
...
8010161c:	83 3d bc 16 11 80 01 	cmpl   $0x1,0x801116bc
{
...
8010164f:	3b 3d bc 16 11 80    	cmp    0x801116bc,%edi
80101655:	73 69                	jae    801016c0 <ialloc+0xb0>
    bp = bread(dev, IBLOCK(inum, sb));
80101657:	89 f8                	mov    %edi,%eax
80101659:	83 ec 08             	sub    $0x8,%esp
8010165c:	c1 e8 03             	shr    $0x3,%eax
8010165f:	03 05 c8 16 11 80    	add    0x801116c8,%eax
...
801016e4:	03 05 c8 16 11 80    	add    0x801116c8,%eax
...
80101757:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&icache.lock);
8010175a:	68 60 fa 10 80       	push   $0x8010fa60
8010175f:	e8 3c 2e 00 00       	call   801045a0 <acquire>
  ip->ref++;
80101764:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101768:	c7 04 24 60 fa 10 80 	movl   $0x8010fa60,(%esp)
...
801017c9:	03 05 c8 16 11 80    	add    0x801116c8,%eax
...
801018da:	e8 61 2a 00 00       	call   80104340 <releasesleep>
  acquire(&icache.lock);
801018df:	c7 04 24 60 fa 10 80 	movl   $0x8010fa60,(%esp)
801018e6:	e8 b5 2c 00 00       	call   801045a0 <acquire>
  ip->ref--;
801018eb:	83 6b 08 01          	subl   $0x1,0x8(%ebx)
  release(&icache.lock);
801018ef:	83 c4 10             	add    $0x10,%esp
801018f2:	c7 45 08 60 fa 10 80 	movl   $0x8010fa60,0x8(%ebp)
}
...
8010190b:	68 60 fa 10 80       	push   $0x8010fa60
80101910:	e8 8b 2c 00 00       	call   801045a0 <acquire>
    int r = ip->ref;
80101915:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101918:	c7 04 24 60 fa 10 80 	movl   $0x8010fa60,(%esp)
...
80101b6a:	8b 04 c5 00 fa 10 80 	mov    -0x7fef0600(,%eax,8),%eax
...
80101c7a:	8b 04 c5 04 fa 10 80 	mov    -0x7fef05fc(,%eax,8),%eax
...
80101db2:	8b 70 68             	mov    0x68(%eax),%esi
  acquire(&icache.lock);
80101db5:	68 60 fa 10 80       	push   $0x8010fa60
80101dba:	e8 e1 27 00 00       	call   801045a0 <acquire>
  ip->ref++;
80101dbf:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101dc3:	c7 04 24 60 fa 10 80 	movl   $0x8010fa60,(%esp)
...
801021cb:	68 00 17 11 80       	push   $0x80111700
801021d0:	e8 fb 21 00 00       	call   801043d0 <initlock>
  ioapicenable(IRQ_IDE, ncpu - 1);
801021d5:	58                   	pop    %eax
801021d6:	a1 84 18 11 80       	mov    0x80111884,%eax
801021db:	5a                   	pop    %edx
...
80102218:	74 f6                	je     80102210 <ideinit+0x50>
      havedisk1 = 1;
8010221a:	c7 05 e0 16 11 80 01 	movl   $0x1,0x801116e0
80102221:	00 00 00 
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
...
80102246:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&idelock);
80102249:	68 00 17 11 80       	push   $0x80111700
8010224e:	e8 4d 23 00 00       	call   801045a0 <acquire>

  if((b = idequeue) == 0){
80102253:	8b 1d e4 16 11 80    	mov    0x801116e4,%ebx
...
80102263:	a3 e4 16 11 80       	mov    %eax,0x801116e4
...
801022ad:	e8 4e 1e 00 00       	call   80104100 <wakeup>
  ...
  if(idequeue != 0)
801022b2:	a1 e4 16 11 80       	mov    0x801116e4,%eax
...
801022c6:	68 00 17 11 80       	push   $0x80111700
...
80102313:	a1 e0 16 11 80       	mov    0x801116e0,%eax
...
80102323:	68 00 17 11 80       	push   $0x80111700
80102328:	e8 73 22 00 00       	call   801045a0 <acquire>

  // Append b to idequeue.
  b->qnext = 0;
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
8010232d:	a1 e4 16 11 80       	mov    0x801116e4,%eax
  b->qnext = 0;
...
8010234c:	89 1a                	mov    %ebx,(%edx)
  ...
  if(idequeue == b)
8010234e:	39 1d e4 16 11 80    	cmp    %ebx,0x801116e4
...
80102363:	68 00 17 11 80       	push   $0x80111700
...
80102379:	75 e5                	jne    80102360 <iderw+0x80>
  ...
  release(&idelock);
8010237b:	c7 45 08 00 17 11 80 	movl   $0x80111700,0x8(%ebp)
}
...
80102399:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
801023a0:	ba e4 16 11 80       	mov    $0x801116e4,%edx
...
801023d1:	c7 05 34 17 11 80 00 	movl   $0xfec00000,0x80111734
801023d8:	00 c0 fe 
{
...
801023e6:	00 00 00 
  return ioapic->data;
801023e9:	8b 15 34 17 11 80    	mov    0x80111734,%edx
801023ef:	8b 72 10             	mov    0x10(%edx),%esi
  ioapic->reg = reg;
801023f2:	c7 02 00 00 00 00    	movl   $0x0,(%edx)
  return ioapic->data;
801023f8:	8b 0d 34 17 11 80    	mov    0x80111734,%ecx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
  id = ioapicread(REG_ID) >> 24;
  if(id != ioapicid)
801023fe:	0f b6 15 80 18 11 80 	movzbl 0x80111880,%edx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
...
8010241f:	e8 7c e2 ff ff       	call   801006a0 <cprintf>
  ioapic->reg = reg;
80102424:	8b 0d 34 17 11 80    	mov    0x80111734,%ecx
...
80102442:	89 c3                	mov    %eax,%ebx
  ioapic->data = data;
80102444:	8b 0d 34 17 11 80    	mov    0x80111734,%ecx
  for(i = 0; i <= maxintr; i++){
...
8010245c:	89 19                	mov    %ebx,(%ecx)
  ioapic->data = data;
8010245e:	8b 0d 34 17 11 80    	mov    0x80111734,%ecx
...
80102480:	55                   	push   %ebp
  ioapic->reg = reg;
80102481:	8b 0d 34 17 11 80    	mov    0x80111734,%ecx
{
...
80102493:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
80102495:	8b 0d 34 17 11 80    	mov    0x80111734,%ecx
...
801024a4:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
801024a6:	a1 34 17 11 80       	mov    0x80111734,%eax
  ioapicwrite(REG_TABLE+2*irq+1, cpunum << 24);
...
801024f2:	e8 69 21 00 00       	call   80104660 <memset>
  ...
  if(kmem.use_lock)
801024f7:	8b 15 74 17 11 80    	mov    0x80111774,%edx
...
80102504:	a1 78 17 11 80       	mov    0x80111778,%eax
80102509:	89 03                	mov    %eax,(%ebx)
  kmem.freelist = r;
  if(kmem.use_lock)
8010250b:	a1 74 17 11 80       	mov    0x80111774,%eax
  kmem.freelist = r;
80102510:	89 1d 78 17 11 80    	mov    %ebx,0x80111778
  if(kmem.use_lock)
...
80102523:	68 40 17 11 80       	push   $0x80111740
80102528:	e8 73 20 00 00       	call   801045a0 <acquire>
8010252d:	83 c4 10             	add    $0x10,%esp
80102530:	eb d2                	jmp    80102504 <kfree+0x44>
80102532:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    release(&kmem.lock);
80102538:	c7 45 08 40 17 11 80 	movl   $0x80111740,0x8(%ebp)
}
...
801025f2:	73 e4                	jae    801025d8 <kinit2+0x28>
  kmem.use_lock = 1;
801025f4:	c7 05 74 17 11 80 01 	movl   $0x1,0x80111774
801025fb:	00 00 00 
}
...
80102620:	68 40 17 11 80       	push   $0x80111740
...
8010262d:	83 c4 10             	add    $0x10,%esp
  kmem.use_lock = 0;
80102630:	c7 05 74 17 11 80 00 	movl   $0x0,0x80111774
80102637:	00 00 00 
  p = (char*)PGROUNDUP((uint)vstart);
...
kalloc(void)
{
  ...
  if(kmem.use_lock)
80102680:	a1 74 17 11 80       	mov    0x80111774,%eax
80102685:	85 c0                	test   %eax,%eax
80102687:	75 1f                	jne    801026a8 <kalloc+0x28>
    acquire(&kmem.lock);
  r = kmem.freelist;
80102689:	a1 78 17 11 80       	mov    0x80111778,%eax
  if(r)
8010268e:	85 c0                	test   %eax,%eax
80102690:	74 0e                	je     801026a0 <kalloc+0x20>
    kmem.freelist = r->next;
80102692:	8b 10                	mov    (%eax),%edx
80102694:	89 15 78 17 11 80    	mov    %edx,0x80111778
  if(kmem.use_lock)
8010269a:	c3                   	ret    
...
801026ab:	83 ec 24             	sub    $0x24,%esp
    acquire(&kmem.lock);
801026ae:	68 40 17 11 80       	push   $0x80111740
801026b3:	e8 e8 1e 00 00       	call   801045a0 <acquire>
  r = kmem.freelist;
801026b8:	a1 78 17 11 80       	mov    0x80111778,%eax
  if(kmem.use_lock)
801026bd:	8b 15 74 17 11 80    	mov    0x80111774,%edx
  if(r)
...
801026cc:	89 0d 78 17 11 80    	mov    %ecx,0x80111778
  if(kmem.use_lock)
...
801026dc:	68 40 17 11 80       	push   $0x80111740
...
80102707:	ec                   	in     (%dx),%al
  ...
  if(data == 0xE0){
    shift |= E0ESC;
80102708:	8b 1d 7c 17 11 80    	mov    0x8011177c,%ebx
  data = inb(KBDATAP);
...
8010273d:	89 d0                	mov    %edx,%eax
  shift ^= togglecode[data];
8010273f:	89 15 7c 17 11 80    	mov    %edx,0x8011177c
  c = charcode[shift & (CTL | SHIFT)][data];
...
80102773:	31 c0                	xor    %eax,%eax
    shift |= E0ESC;
80102775:	89 1d 7c 17 11 80    	mov    %ebx,0x8011177c
}
...
80102799:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    shift &= ~(shiftcode[data] | E0ESC);
8010279c:	a3 7c 17 11 80       	mov    %eax,0x8011177c
    return 0;
...
{
  if(!lapic)
801027f0:	a1 80 17 11 80       	mov    0x80111780,%eax
...
{
  if (!lapic)
801028f0:	a1 80 17 11 80       	mov    0x80111780,%eax
...
{
  if(lapic)
80102910:	a1 80 17 11 80       	mov    0x80111780,%eax
...
80102978:	66 a3 69 04 00 80    	mov    %ax,0x80000469
  lapic[index] = value;
8010297e:	a1 80 17 11 80       	mov    0x80111780,%eax
...
80102bc0:	8b 0d e8 17 11 80    	mov    0x801117e8,%ecx
...
80102be0:	a1 d4 17 11 80       	mov    0x801117d4,%eax
80102be5:	83 ec 08             	sub    $0x8,%esp
80102be8:	01 f8                	add    %edi,%eax
80102bea:	83 c0 01             	add    $0x1,%eax
80102bed:	50                   	push   %eax
80102bee:	ff 35 e4 17 11 80    	push   0x801117e4
80102bf4:	e8 d7 d4 ff ff       	call   801000d0 <bread>
80102bf9:	89 c6                	mov    %eax,%esi
    struct buf *dbuf = bread(log.dev, log.lh.block[tail]); // read dst
80102bfb:	58                   	pop    %eax
80102bfc:	5a                   	pop    %edx
80102bfd:	ff 34 bd ec 17 11 80 	push   -0x7feee814(,%edi,4)
80102c04:	ff 35 e4 17 11 80    	push   0x801117e4
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102c44:	39 3d e8 17 11 80    	cmp    %edi,0x801117e8
...
80102c67:	ff 35 d4 17 11 80    	push   0x801117d4
80102c6d:	ff 35 e4 17 11 80    	push   0x801117e4
...
80102c7b:	89 c3                	mov    %eax,%ebx
  hb->n = log.lh.n;
80102c7d:	a1 e8 17 11 80       	mov    0x801117e8,%eax
...
80102c90:	8b 0c 95 ec 17 11 80 	mov    -0x7feee814(,%edx,4),%ecx
...
80102ccf:	68 a0 17 11 80       	push   $0x801117a0
...
80102ce8:	59                   	pop    %ecx
  log.dev = dev;
80102ce9:	89 1d e4 17 11 80    	mov    %ebx,0x801117e4
  log.size = sb.nlog;
80102cef:	8b 55 e8             	mov    -0x18(%ebp),%edx
  log.start = sb.logstart;
80102cf2:	a3 d4 17 11 80       	mov    %eax,0x801117d4
  log.size = sb.nlog;
80102cf7:	89 15 d8 17 11 80    	mov    %edx,0x801117d8
  struct buf *buf = bread(log.dev, log.start);
80102cfd:	5a                   	pop    %edx
...
80102d0b:	89 1d e8 17 11 80    	mov    %ebx,0x801117e8
  for (i = 0; i < log.lh.n; i++) {
...
80102d24:	89 0c 95 ec 17 11 80 	mov    %ecx,-0x7feee814(,%edx,4)
  for (i = 0; i < log.lh.n; i++) {
...
80102d3b:	e8 80 fe ff ff       	call   80102bc0 <install_trans>
  log.lh.n = 0;
80102d40:	c7 05 e8 17 11 80 00 	movl   $0x0,0x801117e8
80102d47:	00 00 00 
...
80102d63:	83 ec 14             	sub    $0x14,%esp
  acquire(&log.lock);
80102d66:	68 a0 17 11 80       	push   $0x801117a0
...
80102d7b:	68 a0 17 11 80       	push   $0x801117a0
80102d80:	68 a0 17 11 80       	push   $0x801117a0
80102d85:	e8 b6 12 00 00       	call   80104040 <sleep>
80102d8a:	83 c4 10             	add    $0x10,%esp
    if(log.committing){
80102d8d:	a1 e0 17 11 80       	mov    0x801117e0,%eax
80102d92:	85 c0                	test   %eax,%eax
80102d94:	75 e2                	jne    80102d78 <begin_op+0x18>
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
80102d96:	a1 dc 17 11 80       	mov    0x801117dc,%eax
80102d9b:	8b 15 e8 17 11 80    	mov    0x801117e8,%edx
...
80102daf:	83 ec 0c             	sub    $0xc,%esp
      log.outstanding += 1;
80102db2:	a3 dc 17 11 80       	mov    %eax,0x801117dc
      release(&log.lock);
80102db7:	68 a0 17 11 80       	push   $0x801117a0
...
80102dd6:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&log.lock);
80102dd9:	68 a0 17 11 80       	push   $0x801117a0
80102dde:	e8 bd 17 00 00       	call   801045a0 <acquire>
  log.outstanding -= 1;
80102de3:	a1 dc 17 11 80       	mov    0x801117dc,%eax
  if(log.committing)
80102de8:	8b 35 e0 17 11 80    	mov    0x801117e0,%esi
80102dee:	83 c4 10             	add    $0x10,%esp
  log.outstanding -= 1;
80102df1:	8d 58 ff             	lea    -0x1(%eax),%ebx
80102df4:	89 1d dc 17 11 80    	mov    %ebx,0x801117dc
  if(log.committing)
...
80102e04:	0f 85 f6 00 00 00    	jne    80102f00 <end_op+0x130>
    do_commit = 1;
    log.committing = 1;
80102e0a:	c7 05 e0 17 11 80 01 	movl   $0x1,0x801117e0
80102e11:	00 00 00 
...
80102e17:	68 a0 17 11 80       	push   $0x801117a0
...
{
  if (log.lh.n > 0) {
80102e21:	8b 0d e8 17 11 80    	mov    0x801117e8,%ecx
80102e27:	83 c4 10             	add    $0x10,%esp
80102e2a:	85 c9                	test   %ecx,%ecx
80102e2c:	7f 42                	jg     80102e70 <end_op+0xa0>
    acquire(&log.lock);
80102e2e:	83 ec 0c             	sub    $0xc,%esp
80102e31:	68 a0 17 11 80       	push   $0x801117a0
80102e36:	e8 65 17 00 00       	call   801045a0 <acquire>
    wakeup(&log);
80102e3b:	c7 04 24 a0 17 11 80 	movl   $0x801117a0,(%esp)
    log.committing = 0;
80102e42:	c7 05 e0 17 11 80 00 	movl   $0x0,0x801117e0
80102e49:	00 00 00 
    wakeup(&log);
80102e4c:	e8 af 12 00 00       	call   80104100 <wakeup>
    release(&log.lock);
80102e51:	c7 04 24 a0 17 11 80 	movl   $0x801117a0,(%esp)
...
80102e70:	a1 d4 17 11 80       	mov    0x801117d4,%eax
80102e75:	83 ec 08             	sub    $0x8,%esp
80102e78:	01 d8                	add    %ebx,%eax
80102e7a:	83 c0 01             	add    $0x1,%eax
80102e7d:	50                   	push   %eax
80102e7e:	ff 35 e4 17 11 80    	push   0x801117e4
80102e84:	e8 47 d2 ff ff       	call   801000d0 <bread>
80102e89:	89 c6                	mov    %eax,%esi
    struct buf *from = bread(log.dev, log.lh.block[tail]); // cache block
80102e8b:	58                   	pop    %eax
80102e8c:	5a                   	pop    %edx
80102e8d:	ff 34 9d ec 17 11 80 	push   -0x7feee814(,%ebx,4)
80102e94:	ff 35 e4 17 11 80    	push   0x801117e4
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102ed4:	3b 1d e8 17 11 80    	cmp    0x801117e8,%ebx
...
80102ee1:	e8 da fc ff ff       	call   80102bc0 <install_trans>
    log.lh.n = 0;
80102ee6:	c7 05 e8 17 11 80 00 	movl   $0x0,0x801117e8
80102eed:	00 00 00 
...
80102f03:	68 a0 17 11 80       	push   $0x801117a0
80102f08:	e8 f3 11 00 00       	call   80104100 <wakeup>
  release(&log.lock);
80102f0d:	c7 04 24 a0 17 11 80 	movl   $0x801117a0,(%esp)
...
80102f47:	8b 15 e8 17 11 80    	mov    0x801117e8,%edx
{
80102f4d:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
80102f50:	83 fa 1d             	cmp    $0x1d,%edx
80102f53:	0f 8f 85 00 00 00    	jg     80102fde <log_write+0x9e>
80102f59:	a1 d8 17 11 80       	mov    0x801117d8,%eax
80102f5e:	83 e8 01             	sub    $0x1,%eax
80102f61:	39 c2                	cmp    %eax,%edx
80102f63:	7d 79                	jge    80102fde <log_write+0x9e>
    panic("too big a transaction");
  if (log.outstanding < 1)
80102f65:	a1 dc 17 11 80       	mov    0x801117dc,%eax
...
80102f71:	68 a0 17 11 80       	push   $0x801117a0
80102f76:	e8 25 16 00 00       	call   801045a0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
80102f7b:	8b 15 e8 17 11 80    	mov    0x801117e8,%edx
...
80102f95:	74 29                	je     80102fc0 <log_write+0x80>
    if (log.lh.block[i] == b->blockno)   // log absorbtion
80102f97:	39 0c 85 ec 17 11 80 	cmp    %ecx,-0x7feee814(,%eax,4)
80102f9e:	75 f0                	jne    80102f90 <log_write+0x50>
      break;
  }
  log.lh.block[i] = b->blockno;
80102fa0:	89 0c 85 ec 17 11 80 	mov    %ecx,-0x7feee814(,%eax,4)
  if (i == log.lh.n)
    log.lh.n++;
...
80102faa:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  release(&log.lock);
80102fad:	c7 45 08 a0 17 11 80 	movl   $0x801117a0,0x8(%ebp)
}
80102fb4:	c9                   	leave  
  release(&log.lock);
...
80102fba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  log.lh.block[i] = b->blockno;
80102fc0:	89 0c 95 ec 17 11 80 	mov    %ecx,-0x7feee814(,%edx,4)
    log.lh.n++;
80102fc7:	83 c2 01             	add    $0x1,%edx
80102fca:	89 15 e8 17 11 80    	mov    %edx,0x801117e8
80102fd0:	eb d5                	jmp    80102fa7 <log_write+0x67>
  log.lh.block[i] = b->blockno;
80102fd2:	8b 43 08             	mov    0x8(%ebx),%eax
80102fd5:	a3 ec 17 11 80       	mov    %eax,0x801117ec
  if (i == log.lh.n)
...
801030ca:	68 8c a5 10 80       	push   $0x8010a58c
801030cf:	68 00 70 00 80       	push   $0x80007000
801030d4:	e8 27 16 00 00       	call   80104700 <memmove>

  for(c = cpus; c < cpus+ncpu; c++){
801030d9:	83 c4 10             	add    $0x10,%esp
801030dc:	69 05 84 18 11 80 b0 	imul   $0xb0,0x80111884,%eax
801030e3:	00 00 00 
801030e6:	05 a0 18 11 80       	add    $0x801118a0,%eax
801030eb:	3d a0 18 11 80       	cmp    $0x801118a0,%eax
801030f0:	76 7e                	jbe    80103170 <main+0x110>
801030f2:	bb a0 18 11 80       	mov    $0x801118a0,%ebx
801030f7:	eb 20                	jmp    80103119 <main+0xb9>
801030f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103100:	69 05 84 18 11 80 b0 	imul   $0xb0,0x80111884,%eax
80103107:	00 00 00 
8010310a:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
80103110:	05 a0 18 11 80       	add    $0x801118a0,%eax
...
801032d6:	a3 80 17 11 80       	mov    %eax,0x80111780
...
80103354:	83 c0 08             	add    $0x8,%eax
      ioapicid = ioapic->apicno;
80103357:	88 0d 80 18 11 80    	mov    %cl,0x80111880
      continue;
8010335d:	eb 99                	jmp    801032f8 <mpinit+0xe8>
8010335f:	90                   	nop
      if(ncpu < NCPU) {
80103360:	8b 0d 84 18 11 80    	mov    0x80111884,%ecx
...
80103378:	89 0d 84 18 11 80    	mov    %ecx,0x80111884
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
8010337e:	88 9f a0 18 11 80    	mov    %bl,-0x7feee760(%edi)
...
801037b4:	bb 54 1e 11 80       	mov    $0x80111e54,%ebx
{
801037b9:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
801037bc:	68 20 1e 11 80       	push   $0x80111e20
...
801037f4:	8d 50 01             	lea    0x1(%eax),%edx
  release(&ptable.lock);
801037f7:	68 20 1e 11 80       	push   $0x80111e20
  p->pid = nextpid++;
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 f2 59 10 80 	movl   $0x801059f2,0x14(%eax)
  p->context = (struct context*)sp;
...
80103853:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
80103855:	68 20 1e 11 80       	push   $0x80111e20
...
80103883:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
80103886:	68 20 1e 11 80       	push   $0x80111e20
...
801038db:	68 20 1e 11 80       	push   $0x80111e20
...
801038fc:	e8 ef ef ff ff       	call   801028f0 <lapicid>
  for (i = 0; i < ncpu; ++i) {
80103901:	8b 35 84 18 11 80    	mov    0x80111884,%esi
...
8010391d:	0f b6 99 a0 18 11 80 	movzbl -0x7feee760(%ecx),%ebx
80103924:	39 c3                	cmp    %eax,%ebx
80103926:	75 e8                	jne    80103910 <mycpu+0x20>
}
80103928:	8d 65 f8             	lea    -0x8(%ebp),%esp
      return &cpus[i];
8010392b:	8d 81 a0 18 11 80    	lea    -0x7feee760(%ecx),%eax
}
80103931:	5b                   	pop    %ebx
80103932:	5e                   	pop    %esi
80103933:	5d                   	pop    %ebp
...
8010395b:	c9                   	leave  
  return mycpu()-cpus;
8010395c:	2d a0 18 11 80       	sub    $0x801118a0,%eax
...
801039cb:	68 60 a5 10 80       	push   $0x8010a560
...
80103a56:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103a59:	c7 04 24 20 1e 11 80 	movl   $0x80111e20,(%esp)
80103a60:	e8 3b 0b 00 00       	call   801045a0 <acquire>
  p->state = RUNNABLE;
80103a65:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103a6c:	c7 04 24 20 1e 11 80 	movl   $0x80111e20,(%esp)
...
80103bc6:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103bc9:	c7 04 24 20 1e 11 80 	movl   $0x80111e20,(%esp)
80103bd0:	e8 cb 09 00 00       	call   801045a0 <acquire>
  np->state = RUNNABLE;
80103bd5:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103bdc:	c7 04 24 20 1e 11 80 	movl   $0x80111e20,(%esp)
...
80103c51:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c54:	bb 54 1e 11 80       	mov    $0x80111e54,%ebx
    acquire(&ptable.lock);
80103c59:	68 20 1e 11 80       	push   $0x80111e20
...
80103cb7:	68 20 1e 11 80       	push   $0x80111e20
...
80103ced:	68 20 1e 11 80       	push   $0x80111e20
...
80103dec:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  acquire(&ptable.lock);
80103df3:	c7 04 24 20 1e 11 80 	movl   $0x80111e20,(%esp)
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e05:	b8 54 1e 11 80       	mov    $0x80111e54,%eax
...
80103e36:	8b 0d 54 3d 11 80    	mov    0x80113d54,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e3c:	ba 54 1e 11 80       	mov    $0x80111e54,%edx
...
80103e5f:	75 e7                	jne    80103e48 <exit+0xb8>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e61:	b8 54 1e 11 80       	mov    $0x80111e54,%eax
...
80103fa7:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103fae:	c7 04 24 20 1e 11 80 	movl   $0x80111e20,(%esp)
...
80103fc9:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103fce:	68 20 1e 11 80       	push   $0x80111e20
...
80103ff7:	68 20 1e 11 80       	push   $0x80111e20
...
8010401d:	e8 ae fc ff ff       	call   80103cd0 <sched>
  release(&ptable.lock);
80104022:	c7 04 24 20 1e 11 80 	movl   $0x80111e20,(%esp)
...
80104070:	81 fe 20 1e 11 80    	cmp    $0x80111e20,%esi
80104076:	74 50                	je     801040c8 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104078:	83 ec 0c             	sub    $0xc,%esp
8010407b:	68 20 1e 11 80       	push   $0x80111e20
...
8010409c:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
801040a3:	c7 04 24 20 1e 11 80 	movl   $0x80111e20,(%esp)
...
80104107:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
8010410a:	68 20 1e 11 80       	push   $0x80111e20
8010410f:	e8 8c 04 00 00       	call   801045a0 <acquire>
80104114:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104117:	b8 54 1e 11 80       	mov    $0x80111e54,%eax
...
80104144:	75 e4                	jne    8010412a <wakeup+0x2a>
  wakeup1(chan);
  release(&ptable.lock);
80104146:	c7 45 08 20 1e 11 80 	movl   $0x80111e20,0x8(%ebp)
}
...
80104167:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
8010416a:	68 20 1e 11 80       	push   $0x80111e20
8010416f:	e8 2c 04 00 00       	call   801045a0 <acquire>
80104174:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104177:	b8 54 1e 11 80       	mov    $0x80111e54,%eax
...
801041a6:	68 20 1e 11 80       	push   $0x80111e20
...
801041c3:	68 20 1e 11 80       	push   $0x80111e20
...
801041e9:	bb c0 1e 11 80       	mov    $0x80111ec0,%ebx
...
801041fb:	68 c3 7c 10 80       	push   $0x80107cc3
...
80104228:	8b 14 85 8c 79 10 80 	mov    -0x7fef8674(,%eax,4),%edx
      state = "???";
...
801042aa:	68 a4 79 10 80       	push   $0x801079a4
...
801044e5:	68 af 79 10 80       	push   $0x801079af
801044ea:	e8 91 be ff ff       	call   80100380 <panic>
    panic("popcli");
801044ef:	83 ec 0c             	sub    $0xc,%esp
801044f2:	68 c6 79 10 80       	push   $0x801079c6
...
8010455b:	68 cd 79 10 80       	push   $0x801079cd
...
80104650:	68 d5 79 10 80       	push   $0x801079d5
...
80104a7c:	8b 14 85 00 7a 10 80 	mov    -0x7fef8600(,%eax,4),%edx
...
80104aa8:	68 dd 79 10 80       	push   $0x801079dd
...
80104c04:	68 78 7a 10 80       	push   $0x80107a78
...
80104c1c:	68 77 7a 10 80       	push   $0x80107a77
...
80104c31:	68 6b 7a 10 80       	push   $0x80107a6b
...
80104c4f:	68 7a 7a 10 80       	push   $0x80107a7a
80104c54:	e8 27 b7 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104c59:	83 ec 0c             	sub    $0xc,%esp
80104c5c:	68 5c 7a 10 80       	push   $0x80107a5c
...
80104d08:	0f 88 ca 00 00 00    	js     80104dd8 <sys_read+0xe8>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104d0e:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104d12:	0f 87 c0 00 00 00    	ja     80104dd8 <sys_read+0xe8>
80104d18:	e8 53 ec ff ff       	call   80103970 <myproc>
80104d1d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104d20:	8b 74 90 28          	mov    0x28(%eax,%edx,4),%esi
80104d24:	85 f6                	test   %esi,%esi
80104d26:	0f 84 ac 00 00 00    	je     80104dd8 <sys_read+0xe8>
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0) {
80104d2c:	83 ec 08             	sub    $0x8,%esp
80104d2f:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104d32:	50                   	push   %eax
80104d33:	6a 02                	push   $0x2
80104d35:	e8 e6 fb ff ff       	call   80104920 <argint>
80104d3a:	83 c4 10             	add    $0x10,%esp
80104d3d:	85 c0                	test   %eax,%eax
80104d3f:	0f 88 93 00 00 00    	js     80104dd8 <sys_read+0xe8>
...
80104d58:	78 7e                	js     80104dd8 <sys_read+0xe8>
  procname =  myproc()->name;
80104d5a:	e8 11 ec ff ff       	call   80103970 <myproc>
  if (strncmp(procname, "cat", strlen("cat")) == 0){
80104d5f:	83 ec 0c             	sub    $0xc,%esp
80104d62:	68 8a 7a 10 80       	push   $0x80107a8a
  procname =  myproc()->name;
80104d67:	89 c3                	mov    %eax,%ebx
80104d69:	83 c3 6c             	add    $0x6c,%ebx
  if (strncmp(procname, "cat", strlen("cat")) == 0){
80104d6c:	e8 ef fa ff ff       	call   80104860 <strlen>
80104d71:	83 c4 0c             	add    $0xc,%esp
80104d74:	50                   	push   %eax
80104d75:	68 8a 7a 10 80       	push   $0x80107a8a
80104d7a:	53                   	push   %ebx
80104d7b:	e8 f0 f9 ff ff       	call   80104770 <strncmp>
80104d80:	83 c4 10             	add    $0x10,%esp
80104d83:	85 c0                	test   %eax,%eax
80104d85:	74 19                	je     80104da0 <sys_read+0xb0>
  return fileread(f, p, n);
80104d87:	83 ec 04             	sub    $0x4,%esp
80104d8a:	ff 75 f0             	push   -0x10(%ebp)
80104d8d:	ff 75 f4             	push   -0xc(%ebp)
80104d90:	56                   	push   %esi
80104d91:	e8 8a c2 ff ff       	call   80101020 <fileread>
80104d96:	83 c4 10             	add    $0x10,%esp
}
80104d99:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104d9c:	5b                   	pop    %ebx
80104d9d:	5e                   	pop    %esi
80104d9e:	5d                   	pop    %ebp
80104d9f:	c3                   	ret    
      uint filetype = f->ip->type;
80104da0:	8b 46 10             	mov    0x10(%esi),%eax
      if (filetype == 3) {
80104da3:	66 83 78 50 03       	cmpw   $0x3,0x50(%eax)
80104da8:	75 dd                	jne    80104d87 <sys_read+0x97>
        safestrcpy(lastFileOpened, "No args were passed", strlen("No args were passed") + 1);
80104daa:	83 ec 0c             	sub    $0xc,%esp
80104dad:	68 8e 7a 10 80       	push   $0x80107a8e
80104db2:	e8 a9 fa ff ff       	call   80104860 <strlen>
80104db7:	83 c4 0c             	add    $0xc,%esp
80104dba:	83 c0 01             	add    $0x1,%eax
80104dbd:	50                   	push   %eax
80104dbe:	68 8e 7a 10 80       	push   $0x80107a8e
80104dc3:	68 20 a0 10 80       	push   $0x8010a020
80104dc8:	e8 53 fa ff ff       	call   80104820 <safestrcpy>
80104dcd:	83 c4 10             	add    $0x10,%esp
80104dd0:	eb b5                	jmp    80104d87 <sys_read+0x97>
80104dd2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    return -1;
80104dd8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104ddd:	eb ba                	jmp    80104d99 <sys_read+0xa9>
80104ddf:	90                   	nop
...
80104dee:	e8 2d fb ff ff       	call   80104920 <argint>
...
80104e19:	e8 02 fb ff ff       	call   80104920 <argint>
...
80104e2e:	e8 3d fb ff ff       	call   80104970 <argptr>
...
80104ece:	e8 4d fa ff ff       	call   80104920 <argint>
...
80104ef8:	e8 73 fa ff ff       	call   80104970 <argptr>
...
80104f3f:	e8 9c fa ff ff       	call   801049e0 <argstr>
...
80104f58:	e8 83 fa ff ff       	call   801049e0 <argstr>
...
8010508f:	e8 4c f9 ff ff       	call   801049e0 <argstr>
...
801050cd:	58                   	pop    %eax
801050ce:	5a                   	pop    %edx
801050cf:	68 78 7a 10 80       	push   $0x80107a78
...
801050e8:	68 77 7a 10 80       	push   $0x80107a77
...
80105142:	e8 19 f5 ff ff       	call   80104660 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
801051c1:	e8 ca c8 ff ff       	call   80101a90 <readi>
...
80105200:	eb 94                	jmp    80105196 <sys_unlink+0x116>
...
80105214:	e8 b7 c4 ff ff       	call   801016d0 <iupdate>
...
8010527f:	e8 5c f7 ff ff       	call   801049e0 <argstr>
80105284:	83 c4 10             	add    $0x10,%esp
80105287:	85 c0                	test   %eax,%eax
80105289:	0f 88 c6 00 00 00    	js     80105355 <sys_open+0xe5>
8010528f:	83 ec 08             	sub    $0x8,%esp
80105292:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105295:	50                   	push   %eax
80105296:	6a 01                	push   $0x1
80105298:	e8 83 f6 ff ff       	call   80104920 <argint>
8010529d:	83 c4 10             	add    $0x10,%esp
801052a0:	85 c0                	test   %eax,%eax
801052a2:	0f 88 ad 00 00 00    	js     80105355 <sys_open+0xe5>
    return -1;

  //Save the last file opened by cat
  char *procname;
  procname =  myproc()->name;
801052a8:	e8 c3 e6 ff ff       	call   80103970 <myproc>
  // cprintf("Proc Name: %s\n", procname);

  if (strncmp(procname, "cat", strlen("cat")) == 0){
801052ad:	83 ec 0c             	sub    $0xc,%esp
801052b0:	68 8a 7a 10 80       	push   $0x80107a8a
  procname =  myproc()->name;
801052b5:	8d 58 6c             	lea    0x6c(%eax),%ebx
  if (strncmp(procname, "cat", strlen("cat")) == 0){
801052b8:	e8 a3 f5 ff ff       	call   80104860 <strlen>
801052bd:	83 c4 0c             	add    $0xc,%esp
801052c0:	50                   	push   %eax
801052c1:	68 8a 7a 10 80       	push   $0x80107a8a
801052c6:	53                   	push   %ebx
801052c7:	e8 a4 f4 ff ff       	call   80104770 <strncmp>
801052cc:	83 c4 10             	add    $0x10,%esp
801052cf:	85 c0                	test   %eax,%eax
801052d1:	0f 84 01 01 00 00    	je     801053d8 <sys_open+0x168>
    // cprintf("Found Cat\n");
    safestrcpy(lastFileOpened, path, strlen(path) + 1);
  }

  begin_op();
801052d7:	e8 84 da ff ff       	call   80102d60 <begin_op>

  if(omode & O_CREATE){
801052dc:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
801052e0:	75 7e                	jne    80105360 <sys_open+0xf0>
    if(ip == 0){
      end_op();
      return -1;
    }
...
801052e5:	ff 75 e0             	push   -0x20(%ebp)
801052e8:	e8 b3 cd ff ff       	call   801020a0 <namei>
801052ed:	83 c4 10             	add    $0x10,%esp
801052f0:	89 c6                	mov    %eax,%esi
801052f2:	85 c0                	test   %eax,%eax
801052f4:	0f 84 16 01 00 00    	je     80105410 <sys_open+0x1a0>
      if (strncmp(procname, "cat", strlen("cat")) == 0){
        safestrcpy(lastFileOpened, "Invalid filename", strlen("Invalid filename") + 1);
      }
      return -1;
    }
    ilock(ip);
...
801052fe:	e8 7d c4 ff ff       	call   80101780 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105303:	83 c4 10             	add    $0x10,%esp
80105306:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
8010530b:	0f 84 ef 00 00 00    	je     80105400 <sys_open+0x190>
      end_op();
      return -1;
    }
  }
...
80105311:	e8 1a bb ff ff       	call   80100e30 <filealloc>
80105316:	89 c7                	mov    %eax,%edi
80105318:	85 c0                	test   %eax,%eax
8010531a:	74 28                	je     80105344 <sys_open+0xd4>
  struct proc *curproc = myproc();
8010531c:	e8 4f e6 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
80105321:	31 db                	xor    %ebx,%ebx
80105323:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105327:	90                   	nop
    if(curproc->ofile[fd] == 0){
80105328:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
8010532c:	85 d2                	test   %edx,%edx
8010532e:	74 60                	je     80105390 <sys_open+0x120>
  for(fd = 0; fd < NOFILE; fd++){
80105330:	83 c3 01             	add    $0x1,%ebx
80105333:	83 fb 10             	cmp    $0x10,%ebx
80105336:	75 f0                	jne    80105328 <sys_open+0xb8>
    if(f)
      fileclose(f);
80105338:	83 ec 0c             	sub    $0xc,%esp
8010533b:	57                   	push   %edi
8010533c:	e8 af bb ff ff       	call   80100ef0 <fileclose>
...
80105348:	e8 c3 c6 ff ff       	call   80101a10 <iunlockput>
    end_op();
8010534d:	e8 7e da ff ff       	call   80102dd0 <end_op>
    return -1;
80105352:	83 c4 10             	add    $0x10,%esp
80105355:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
8010535a:	eb 6d                	jmp    801053c9 <sys_open+0x159>
8010535c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ip = create(path, T_FILE, 0, 0);
80105360:	83 ec 0c             	sub    $0xc,%esp
80105363:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105366:	31 c9                	xor    %ecx,%ecx
80105368:	ba 02 00 00 00       	mov    $0x2,%edx
...
8010537b:	75 94                	jne    80105311 <sys_open+0xa1>
      end_op();
8010537d:	e8 4e da ff ff       	call   80102dd0 <end_op>
      return -1;
80105382:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80105387:	eb 40                	jmp    801053c9 <sys_open+0x159>
...
80105398:	e8 c3 c4 ff ff       	call   80101860 <iunlock>
  end_op();
8010539d:	e8 2e da ff ff       	call   80102dd0 <end_op>
...
801053db:	ff 75 e0             	push   -0x20(%ebp)
801053de:	e8 7d f4 ff ff       	call   80104860 <strlen>
801053e3:	83 c4 0c             	add    $0xc,%esp
801053e6:	83 c0 01             	add    $0x1,%eax
801053e9:	50                   	push   %eax
801053ea:	ff 75 e0             	push   -0x20(%ebp)
801053ed:	68 20 a0 10 80       	push   $0x8010a020
801053f2:	e8 29 f4 ff ff       	call   80104820 <safestrcpy>
801053f7:	83 c4 10             	add    $0x10,%esp
801053fa:	e9 d8 fe ff ff       	jmp    801052d7 <sys_open+0x67>
801053ff:	90                   	nop
    if(ip->type == T_DIR && omode != O_RDONLY){
80105400:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80105403:	85 c9                	test   %ecx,%ecx
80105405:	0f 84 06 ff ff ff    	je     80105311 <sys_open+0xa1>
8010540b:	e9 34 ff ff ff       	jmp    80105344 <sys_open+0xd4>
      end_op();
80105410:	e8 bb d9 ff ff       	call   80102dd0 <end_op>
      if (strncmp(procname, "cat", strlen("cat")) == 0){
80105415:	83 ec 0c             	sub    $0xc,%esp
80105418:	68 8a 7a 10 80       	push   $0x80107a8a
8010541d:	e8 3e f4 ff ff       	call   80104860 <strlen>
80105422:	83 c4 0c             	add    $0xc,%esp
80105425:	50                   	push   %eax
80105426:	68 8a 7a 10 80       	push   $0x80107a8a
8010542b:	53                   	push   %ebx
8010542c:	e8 3f f3 ff ff       	call   80104770 <strncmp>
80105431:	83 c4 10             	add    $0x10,%esp
80105434:	85 c0                	test   %eax,%eax
80105436:	0f 85 19 ff ff ff    	jne    80105355 <sys_open+0xe5>
        safestrcpy(lastFileOpened, "Invalid filename", strlen("Invalid filename") + 1);
8010543c:	83 ec 0c             	sub    $0xc,%esp
      return -1;
8010543f:	83 cb ff             	or     $0xffffffff,%ebx
        safestrcpy(lastFileOpened, "Invalid filename", strlen("Invalid filename") + 1);
80105442:	68 d5 7a 10 80       	push   $0x80107ad5
80105447:	e8 14 f4 ff ff       	call   80104860 <strlen>
8010544c:	83 c4 0c             	add    $0xc,%esp
8010544f:	83 c0 01             	add    $0x1,%eax
80105452:	50                   	push   %eax
80105453:	68 d5 7a 10 80       	push   $0x80107ad5
80105458:	68 20 a0 10 80       	push   $0x8010a020
8010545d:	e8 be f3 ff ff       	call   80104820 <safestrcpy>
80105462:	83 c4 10             	add    $0x10,%esp
80105465:	e9 5f ff ff ff       	jmp    801053c9 <sys_open+0x159>
8010546a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

80105470 <sys_getlastcat>:
...
80105473:	53                   	push   %ebx
  char *p;
  if (argptr(0, &p, sizeof(p)) || p == (char *)0){
80105474:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
80105477:	83 ec 18             	sub    $0x18,%esp
  if (argptr(0, &p, sizeof(p)) || p == (char *)0){
8010547a:	6a 04                	push   $0x4
8010547c:	50                   	push   %eax
8010547d:	6a 00                	push   $0x0
8010547f:	e8 ec f4 ff ff       	call   80104970 <argptr>
80105484:	83 c4 10             	add    $0x10,%esp
80105487:	85 c0                	test   %eax,%eax
80105489:	75 35                	jne    801054c0 <sys_getlastcat+0x50>
8010548b:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010548e:	85 d2                	test   %edx,%edx
80105490:	74 2e                	je     801054c0 <sys_getlastcat+0x50>
    return -1;
  }
  // Copy characters from test to the buffer pointed to by p
  safestrcpy(p, lastFileOpened, strlen(lastFileOpened) + 1);
80105492:	83 ec 0c             	sub    $0xc,%esp
80105495:	89 c3                	mov    %eax,%ebx
80105497:	68 20 a0 10 80       	push   $0x8010a020
8010549c:	e8 bf f3 ff ff       	call   80104860 <strlen>
801054a1:	83 c4 0c             	add    $0xc,%esp
801054a4:	83 c0 01             	add    $0x1,%eax
801054a7:	50                   	push   %eax
801054a8:	68 20 a0 10 80       	push   $0x8010a020
801054ad:	ff 75 f4             	push   -0xc(%ebp)
801054b0:	e8 6b f3 ff ff       	call   80104820 <safestrcpy>

  return 0;
801054b5:	83 c4 10             	add    $0x10,%esp
}
801054b8:	89 d8                	mov    %ebx,%eax
801054ba:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801054bd:	c9                   	leave  
801054be:	c3                   	ret    
801054bf:	90                   	nop
    return -1;
801054c0:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801054c5:	eb f1                	jmp    801054b8 <sys_getlastcat+0x48>
...
801054ff:	e8 cc f5 ff ff       	call   80104ad0 <create>
...
8010558e:	e8 3d f5 ff ff       	call   80104ad0 <create>
     argint(2, &minor) < 0 ||
...
8010592a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010592d:	8b 1d 60 3d 11 80    	mov    0x80113d60,%ebx
  while(ticks - ticks0 < n){
...
80105948:	68 60 3d 11 80       	push   $0x80113d60
8010594d:	e8 ee e6 ff ff       	call   80104040 <sleep>
  while(ticks - ticks0 < n){
80105952:	a1 60 3d 11 80       	mov    0x80113d60,%eax
...
801059b4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801059b7:	68 80 3d 11 80       	push   $0x80113d80
801059bc:	e8 df eb ff ff       	call   801045a0 <acquire>
  xticks = ticks;
801059c1:	8b 1d 60 3d 11 80    	mov    0x80113d60,%ebx
  release(&tickslock);
801059c7:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
...
80105a10:	8b 14 85 20 a1 10 80 	mov    -0x7fef5ee0(,%eax,4),%edx
...
80105a3f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a42:	a1 20 a2 10 80       	mov    0x8010a220,%eax
80105a47:	c7 05 c2 3f 11 80 08 	movl   $0xef000008,0x80113fc2
80105a4e:	00 00 ef 
  initlock(&tickslock, "time");
80105a51:	68 e6 7a 10 80       	push   $0x80107ae6
...
80105ad4:	ff 24 85 8c 7b 10 80 	jmp    *-0x7fef8474(,%eax,4)
...
80105bb5:	68 48 7b 10 80       	push   $0x80107b48
...
80105c07:	68 f0 7a 10 80       	push   $0x80107af0
...
80105c45:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105c48:	e8 13 ee ff ff       	call   80104a60 <syscall>
    if(myproc()->killed)
...
80105cc5:	e8 d6 e8 ff ff       	call   801045a0 <acquire>
      wakeup(&ticks);
...
80105ce4:	e8 57 e8 ff ff       	call   80104540 <release>
...
80105d23:	68 14 7b 10 80       	push   $0x80107b14
80105d28:	e8 73 a9 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105d2d:	83 c4 14             	add    $0x14,%esp
80105d30:	68 eb 7a 10 80       	push   $0x80107aeb
...
80105ddc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105ddf:	bf 0c 7c 10 80       	mov    $0x80107c0c,%edi
...
80105ec7:	6a 00                	push   $0x0
  jmp alltraps
80105ec9:	e9 0c fb ff ff       	jmp    801059da <alltraps>
...
80105ed0:	6a 01                	push   $0x1
  jmp alltraps
80105ed2:	e9 03 fb ff ff       	jmp    801059da <alltraps>
...
80105ed9:	6a 02                	push   $0x2
  jmp alltraps
80105edb:	e9 fa fa ff ff       	jmp    801059da <alltraps>
...
80105ee2:	6a 03                	push   $0x3
  jmp alltraps
80105ee4:	e9 f1 fa ff ff       	jmp    801059da <alltraps>
...
80105eeb:	6a 04                	push   $0x4
  jmp alltraps
80105eed:	e9 e8 fa ff ff       	jmp    801059da <alltraps>
...
80105efd:	6a 06                	push   $0x6
  jmp alltraps
80105eff:	e9 d6 fa ff ff       	jmp    801059da <alltraps>
...
80105f06:	6a 07                	push   $0x7
  jmp alltraps
80105f08:	e9 cd fa ff ff       	jmp    801059da <alltraps>
...
80105f0d:	6a 08                	push   $0x8
  jmp alltraps
80105f0f:	e9 c6 fa ff ff       	jmp    801059da <alltraps>
...
80105f16:	6a 09                	push   $0x9
  jmp alltraps
80105f18:	e9 bd fa ff ff       	jmp    801059da <alltraps>
...
80105f1d:	6a 0a                	push   $0xa
  jmp alltraps
80105f1f:	e9 b6 fa ff ff       	jmp    801059da <alltraps>
...
80105f32:	6a 0d                	push   $0xd
  jmp alltraps
80105f34:	e9 a1 fa ff ff       	jmp    801059da <alltraps>
...
80105f39:	6a 0e                	push   $0xe
  jmp alltraps
80105f3b:	e9 9a fa ff ff       	jmp    801059da <alltraps>
...
80105f42:	6a 0f                	push   $0xf
  jmp alltraps
80105f44:	e9 91 fa ff ff       	jmp    801059da <alltraps>
...
80105f4b:	6a 10                	push   $0x10
  jmp alltraps
80105f4d:	e9 88 fa ff ff       	jmp    801059da <alltraps>
...
80105f52:	6a 11                	push   $0x11
  jmp alltraps
80105f54:	e9 81 fa ff ff       	jmp    801059da <alltraps>
...
80105f64:	6a 13                	push   $0x13
  jmp alltraps
80105f66:	e9 6f fa ff ff       	jmp    801059da <alltraps>
...
80105f6d:	6a 14                	push   $0x14
  jmp alltraps
80105f6f:	e9 66 fa ff ff       	jmp    801059da <alltraps>
...
80105f76:	6a 15                	push   $0x15
  jmp alltraps
80105f78:	e9 5d fa ff ff       	jmp    801059da <alltraps>
...
80105f7f:	6a 16                	push   $0x16
  jmp alltraps
80105f81:	e9 54 fa ff ff       	jmp    801059da <alltraps>
...
80105f88:	6a 17                	push   $0x17
  jmp alltraps
80105f8a:	e9 4b fa ff ff       	jmp    801059da <alltraps>
...
80105f91:	6a 18                	push   $0x18
  jmp alltraps
80105f93:	e9 42 fa ff ff       	jmp    801059da <alltraps>
...
80105f9a:	6a 19                	push   $0x19
  jmp alltraps
80105f9c:	e9 39 fa ff ff       	jmp    801059da <alltraps>
...
80105fa3:	6a 1a                	push   $0x1a
  jmp alltraps
80105fa5:	e9 30 fa ff ff       	jmp    801059da <alltraps>
...
80105fac:	6a 1b                	push   $0x1b
  jmp alltraps
80105fae:	e9 27 fa ff ff       	jmp    801059da <alltraps>
...
80105fb5:	6a 1c                	push   $0x1c
  jmp alltraps
80105fb7:	e9 1e fa ff ff       	jmp    801059da <alltraps>
...
80105fbe:	6a 1d                	push   $0x1d
  jmp alltraps
80105fc0:	e9 15 fa ff ff       	jmp    801059da <alltraps>
...
80105fc7:	6a 1e                	push   $0x1e
  jmp alltraps
80105fc9:	e9 0c fa ff ff       	jmp    801059da <alltraps>
...
80105fd0:	6a 1f                	push   $0x1f
  jmp alltraps
80105fd2:	e9 03 fa ff ff       	jmp    801059da <alltraps>
...
80105fd9:	6a 20                	push   $0x20
  jmp alltraps
80105fdb:	e9 fa f9 ff ff       	jmp    801059da <alltraps>
...
80105fe2:	6a 21                	push   $0x21
  jmp alltraps
80105fe4:	e9 f1 f9 ff ff       	jmp    801059da <alltraps>
...
80105feb:	6a 22                	push   $0x22
  jmp alltraps
80105fed:	e9 e8 f9 ff ff       	jmp    801059da <alltraps>
...
80105ffd:	6a 24                	push   $0x24
  jmp alltraps
80105fff:	e9 d6 f9 ff ff       	jmp    801059da <alltraps>
...
80106006:	6a 25                	push   $0x25
  jmp alltraps
80106008:	e9 cd f9 ff ff       	jmp    801059da <alltraps>
...
8010600f:	6a 26                	push   $0x26
  jmp alltraps
80106011:	e9 c4 f9 ff ff       	jmp    801059da <alltraps>
...
80106018:	6a 27                	push   $0x27
  jmp alltraps
8010601a:	e9 bb f9 ff ff       	jmp    801059da <alltraps>
...
80106021:	6a 28                	push   $0x28
  jmp alltraps
80106023:	e9 b2 f9 ff ff       	jmp    801059da <alltraps>
...
8010602a:	6a 29                	push   $0x29
  jmp alltraps
8010602c:	e9 a9 f9 ff ff       	jmp    801059da <alltraps>
...
80106033:	6a 2a                	push   $0x2a
  jmp alltraps
80106035:	e9 a0 f9 ff ff       	jmp    801059da <alltraps>
...
8010603c:	6a 2b                	push   $0x2b
  jmp alltraps
8010603e:	e9 97 f9 ff ff       	jmp    801059da <alltraps>
...
80106045:	6a 2c                	push   $0x2c
  jmp alltraps
80106047:	e9 8e f9 ff ff       	jmp    801059da <alltraps>
...
8010604e:	6a 2d                	push   $0x2d
  jmp alltraps
80106050:	e9 85 f9 ff ff       	jmp    801059da <alltraps>
...
80106057:	6a 2e                	push   $0x2e
  jmp alltraps
80106059:	e9 7c f9 ff ff       	jmp    801059da <alltraps>
...
80106060:	6a 2f                	push   $0x2f
  jmp alltraps
80106062:	e9 73 f9 ff ff       	jmp    801059da <alltraps>
...
80106069:	6a 30                	push   $0x30
  jmp alltraps
8010606b:	e9 6a f9 ff ff       	jmp    801059da <alltraps>
...
80106072:	6a 31                	push   $0x31
  jmp alltraps
80106074:	e9 61 f9 ff ff       	jmp    801059da <alltraps>
...
8010607b:	6a 32                	push   $0x32
  jmp alltraps
8010607d:	e9 58 f9 ff ff       	jmp    801059da <alltraps>
...
80106084:	6a 33                	push   $0x33
  jmp alltraps
80106086:	e9 4f f9 ff ff       	jmp    801059da <alltraps>
...
8010608d:	6a 34                	push   $0x34
  jmp alltraps
8010608f:	e9 46 f9 ff ff       	jmp    801059da <alltraps>
...
80106096:	6a 35                	push   $0x35
  jmp alltraps
80106098:	e9 3d f9 ff ff       	jmp    801059da <alltraps>
...
8010609f:	6a 36                	push   $0x36
  jmp alltraps
801060a1:	e9 34 f9 ff ff       	jmp    801059da <alltraps>
...
801060a8:	6a 37                	push   $0x37
  jmp alltraps
801060aa:	e9 2b f9 ff ff       	jmp    801059da <alltraps>
...
801060b1:	6a 38                	push   $0x38
  jmp alltraps
801060b3:	e9 22 f9 ff ff       	jmp    801059da <alltraps>
...
801060ba:	6a 39                	push   $0x39
  jmp alltraps
801060bc:	e9 19 f9 ff ff       	jmp    801059da <alltraps>
...
801060c3:	6a 3a                	push   $0x3a
  jmp alltraps
801060c5:	e9 10 f9 ff ff       	jmp    801059da <alltraps>
...
801060cc:	6a 3b                	push   $0x3b
  jmp alltraps
801060ce:	e9 07 f9 ff ff       	jmp    801059da <alltraps>
...
801060d5:	6a 3c                	push   $0x3c
  jmp alltraps
801060d7:	e9 fe f8 ff ff       	jmp    801059da <alltraps>
...
801060de:	6a 3d                	push   $0x3d
  jmp alltraps
801060e0:	e9 f5 f8 ff ff       	jmp    801059da <alltraps>
...
801060e7:	6a 3e                	push   $0x3e
  jmp alltraps
801060e9:	e9 ec f8 ff ff       	jmp    801059da <alltraps>
...
801060f0:	6a 3f                	push   $0x3f
  jmp alltraps
801060f2:	e9 e3 f8 ff ff       	jmp    801059da <alltraps>
...
801060f9:	6a 40                	push   $0x40
  jmp alltraps
801060fb:	e9 da f8 ff ff       	jmp    801059da <alltraps>
...
80106102:	6a 41                	push   $0x41
  jmp alltraps
80106104:	e9 d1 f8 ff ff       	jmp    801059da <alltraps>
...
8010610b:	6a 42                	push   $0x42
  jmp alltraps
8010610d:	e9 c8 f8 ff ff       	jmp    801059da <alltraps>
...
80106114:	6a 43                	push   $0x43
  jmp alltraps
80106116:	e9 bf f8 ff ff       	jmp    801059da <alltraps>
...
8010611d:	6a 44                	push   $0x44
  jmp alltraps
8010611f:	e9 b6 f8 ff ff       	jmp    801059da <alltraps>
...
80106126:	6a 45                	push   $0x45
  jmp alltraps
80106128:	e9 ad f8 ff ff       	jmp    801059da <alltraps>
...
8010612f:	6a 46                	push   $0x46
  jmp alltraps
80106131:	e9 a4 f8 ff ff       	jmp    801059da <alltraps>
...
80106138:	6a 47                	push   $0x47
  jmp alltraps
8010613a:	e9 9b f8 ff ff       	jmp    801059da <alltraps>
...
80106141:	6a 48                	push   $0x48
  jmp alltraps
80106143:	e9 92 f8 ff ff       	jmp    801059da <alltraps>
...
8010614a:	6a 49                	push   $0x49
  jmp alltraps
8010614c:	e9 89 f8 ff ff       	jmp    801059da <alltraps>
...
80106153:	6a 4a                	push   $0x4a
  jmp alltraps
80106155:	e9 80 f8 ff ff       	jmp    801059da <alltraps>
...
8010615c:	6a 4b                	push   $0x4b
  jmp alltraps
8010615e:	e9 77 f8 ff ff       	jmp    801059da <alltraps>
...
80106165:	6a 4c                	push   $0x4c
  jmp alltraps
80106167:	e9 6e f8 ff ff       	jmp    801059da <alltraps>
...
8010616e:	6a 4d                	push   $0x4d
  jmp alltraps
80106170:	e9 65 f8 ff ff       	jmp    801059da <alltraps>
...
80106177:	6a 4e                	push   $0x4e
  jmp alltraps
80106179:	e9 5c f8 ff ff       	jmp    801059da <alltraps>
...
80106180:	6a 4f                	push   $0x4f
  jmp alltraps
80106182:	e9 53 f8 ff ff       	jmp    801059da <alltraps>
...
80106189:	6a 50                	push   $0x50
  jmp alltraps
8010618b:	e9 4a f8 ff ff       	jmp    801059da <alltraps>
...
80106192:	6a 51                	push   $0x51
  jmp alltraps
80106194:	e9 41 f8 ff ff       	jmp    801059da <alltraps>
...
8010619b:	6a 52                	push   $0x52
  jmp alltraps
8010619d:	e9 38 f8 ff ff       	jmp    801059da <alltraps>
...
801061a4:	6a 53                	push   $0x53
  jmp alltraps
801061a6:	e9 2f f8 ff ff       	jmp    801059da <alltraps>
...
801061ad:	6a 54                	push   $0x54
  jmp alltraps
801061af:	e9 26 f8 ff ff       	jmp    801059da <alltraps>
...
801061b6:	6a 55                	push   $0x55
  jmp alltraps
801061b8:	e9 1d f8 ff ff       	jmp    801059da <alltraps>
...
801061bf:	6a 56                	push   $0x56
  jmp alltraps
801061c1:	e9 14 f8 ff ff       	jmp    801059da <alltraps>
...
801061c8:	6a 57                	push   $0x57
  jmp alltraps
801061ca:	e9 0b f8 ff ff       	jmp    801059da <alltraps>
...
801061d1:	6a 58                	push   $0x58
  jmp alltraps
801061d3:	e9 02 f8 ff ff       	jmp    801059da <alltraps>
...
801061da:	6a 59                	push   $0x59
  jmp alltraps
801061dc:	e9 f9 f7 ff ff       	jmp    801059da <alltraps>
...
801061e3:	6a 5a                	push   $0x5a
  jmp alltraps
801061e5:	e9 f0 f7 ff ff       	jmp    801059da <alltraps>
...
801061ec:	6a 5b                	push   $0x5b
  jmp alltraps
801061ee:	e9 e7 f7 ff ff       	jmp    801059da <alltraps>
...
801061f5:	6a 5c                	push   $0x5c
  jmp alltraps
801061f7:	e9 de f7 ff ff       	jmp    801059da <alltraps>
...
801061fe:	6a 5d                	push   $0x5d
  jmp alltraps
80106200:	e9 d5 f7 ff ff       	jmp    801059da <alltraps>
...
80106207:	6a 5e                	push   $0x5e
  jmp alltraps
80106209:	e9 cc f7 ff ff       	jmp    801059da <alltraps>
...
80106210:	6a 5f                	push   $0x5f
  jmp alltraps
80106212:	e9 c3 f7 ff ff       	jmp    801059da <alltraps>
...
80106219:	6a 60                	push   $0x60
  jmp alltraps
8010621b:	e9 ba f7 ff ff       	jmp    801059da <alltraps>
...
80106222:	6a 61                	push   $0x61
  jmp alltraps
80106224:	e9 b1 f7 ff ff       	jmp    801059da <alltraps>
...
8010622b:	6a 62                	push   $0x62
  jmp alltraps
8010622d:	e9 a8 f7 ff ff       	jmp    801059da <alltraps>
...
80106234:	6a 63                	push   $0x63
  jmp alltraps
80106236:	e9 9f f7 ff ff       	jmp    801059da <alltraps>
...
8010623d:	6a 64                	push   $0x64
  jmp alltraps
8010623f:	e9 96 f7 ff ff       	jmp    801059da <alltraps>
...
80106246:	6a 65                	push   $0x65
  jmp alltraps
80106248:	e9 8d f7 ff ff       	jmp    801059da <alltraps>
...
8010624f:	6a 66                	push   $0x66
  jmp alltraps
80106251:	e9 84 f7 ff ff       	jmp    801059da <alltraps>
...
80106258:	6a 67                	push   $0x67
  jmp alltraps
8010625a:	e9 7b f7 ff ff       	jmp    801059da <alltraps>
...
80106261:	6a 68                	push   $0x68
  jmp alltraps
80106263:	e9 72 f7 ff ff       	jmp    801059da <alltraps>
...
8010626a:	6a 69                	push   $0x69
  jmp alltraps
8010626c:	e9 69 f7 ff ff       	jmp    801059da <alltraps>
...
80106273:	6a 6a                	push   $0x6a
  jmp alltraps
80106275:	e9 60 f7 ff ff       	jmp    801059da <alltraps>
...
8010627c:	6a 6b                	push   $0x6b
  jmp alltraps
8010627e:	e9 57 f7 ff ff       	jmp    801059da <alltraps>
...
80106285:	6a 6c                	push   $0x6c
  jmp alltraps
80106287:	e9 4e f7 ff ff       	jmp    801059da <alltraps>
...
8010628e:	6a 6d                	push   $0x6d
  jmp alltraps
80106290:	e9 45 f7 ff ff       	jmp    801059da <alltraps>
...
80106297:	6a 6e                	push   $0x6e
  jmp alltraps
80106299:	e9 3c f7 ff ff       	jmp    801059da <alltraps>
...
801062a0:	6a 6f                	push   $0x6f
  jmp alltraps
801062a2:	e9 33 f7 ff ff       	jmp    801059da <alltraps>
...
801062a9:	6a 70                	push   $0x70
  jmp alltraps
801062ab:	e9 2a f7 ff ff       	jmp    801059da <alltraps>
...
801062b2:	6a 71                	push   $0x71
  jmp alltraps
801062b4:	e9 21 f7 ff ff       	jmp    801059da <alltraps>
...
801062bb:	6a 72                	push   $0x72
  jmp alltraps
801062bd:	e9 18 f7 ff ff       	jmp    801059da <alltraps>
...
801062c4:	6a 73                	push   $0x73
  jmp alltraps
801062c6:	e9 0f f7 ff ff       	jmp    801059da <alltraps>
...
801062cd:	6a 74                	push   $0x74
  jmp alltraps
801062cf:	e9 06 f7 ff ff       	jmp    801059da <alltraps>
...
801062d6:	6a 75                	push   $0x75
  jmp alltraps
801062d8:	e9 fd f6 ff ff       	jmp    801059da <alltraps>
...
801062df:	6a 76                	push   $0x76
  jmp alltraps
801062e1:	e9 f4 f6 ff ff       	jmp    801059da <alltraps>
...
801062e8:	6a 77                	push   $0x77
  jmp alltraps
801062ea:	e9 eb f6 ff ff       	jmp    801059da <alltraps>
...
801062f1:	6a 78                	push   $0x78
  jmp alltraps
801062f3:	e9 e2 f6 ff ff       	jmp    801059da <alltraps>
...
801062fa:	6a 79                	push   $0x79
  jmp alltraps
801062fc:	e9 d9 f6 ff ff       	jmp    801059da <alltraps>
...
80106303:	6a 7a                	push   $0x7a
  jmp alltraps
80106305:	e9 d0 f6 ff ff       	jmp    801059da <alltraps>
...
80106315:	6a 7c                	push   $0x7c
  jmp alltraps
80106317:	e9 be f6 ff ff       	jmp    801059da <alltraps>
...
8010631e:	6a 7d                	push   $0x7d
  jmp alltraps
80106320:	e9 b5 f6 ff ff       	jmp    801059da <alltraps>
...
80106327:	6a 7e                	push   $0x7e
  jmp alltraps
80106329:	e9 ac f6 ff ff       	jmp    801059da <alltraps>
...
80106a85:	e8 d6 db ff ff       	call   80104660 <memset>
...
80106acd:	68 14 7c 10 80       	push   $0x80107c14
...
80106afa:	c7 80 18 19 11 80 ff 	movl   $0xffff,-0x7feee6e8(%eax)
80106b01:	ff 00 00 
80106b04:	c7 80 1c 19 11 80 00 	movl   $0xcf9a00,-0x7feee6e4(%eax)
80106b0b:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106b0e:	c7 80 20 19 11 80 ff 	movl   $0xffff,-0x7feee6e0(%eax)
80106b15:	ff 00 00 
80106b18:	c7 80 24 19 11 80 00 	movl   $0xcf9200,-0x7feee6dc(%eax)
80106b1f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106b22:	c7 80 28 19 11 80 ff 	movl   $0xffff,-0x7feee6d8(%eax)
80106b29:	ff 00 00 
80106b2c:	c7 80 2c 19 11 80 00 	movl   $0xcffa00,-0x7feee6d4(%eax)
80106b33:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106b36:	c7 80 30 19 11 80 ff 	movl   $0xffff,-0x7feee6d0(%eax)
80106b3d:	ff 00 00 
80106b40:	c7 80 34 19 11 80 00 	movl   $0xcff200,-0x7feee6cc(%eax)
80106b47:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106b4a:	05 10 19 11 80       	add    $0x80111910,%eax
  pd[1] = (uint)p;
...
80106ba4:	0f 84 c2 00 00 00    	je     80106c6c <switchuvm+0xec>
  pushcli();
80106baa:	e8 a1 d8 ff ff       	call   80104450 <pushcli>
...
80106cbf:	e8 9c d9 ff ff       	call   80104660 <memset>
...
80106cf2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106cf3:	e9 08 da ff ff       	jmp    80104700 <memmove>
    panic("inituvm: more than a page");
80106cf8:	83 ec 0c             	sub    $0xc,%esp
80106cfb:	68 59 7c 10 80       	push   $0x80107c59
...
80106d60:	68 73 7c 10 80       	push   $0x80107c73
...
80106de8:	68 14 7d 10 80       	push   $0x80107d14
...
80106e4b:	e8 10 d8 ff ff       	call   80104660 <memset>
...
80106e89:	68 91 7c 10 80       	push   $0x80107c91
...
80106eeb:	68 a9 7c 10 80       	push   $0x80107ca9
...
80106fcc:	68 c5 7c 10 80       	push   $0x80107cc5
...
80106ff3:	bb 20 a5 10 80       	mov    $0x8010a520,%ebx
  memset(pgdir, 0, PGSIZE);
80106ff8:	68 00 10 00 00       	push   $0x1000
80106ffd:	6a 00                	push   $0x0
80106fff:	50                   	push   %eax
80107000:	e8 5b d6 ff ff       	call   80104660 <memset>
...
8010702a:	81 fb 60 a5 10 80    	cmp    $0x8010a560,%ebx
...
8010709c:	68 d6 7c 10 80       	push   $0x80107cd6
...
80107112:	68 e0 7c 10 80       	push   $0x80107ce0
...
801071e7:	68 fa 7c 10 80       	push   $0x80107cfa
...
801072a0:	e8 5b d4 ff ff       	call   80104700 <memmove>
    len -= n;
    buf += n;
