...
{    
  ...
  11:	6a 00                	push   $0x0
  13:	e8 0b 03 00 00       	call   323 <getlastcat>
    printf(1,"XV6_TEST_OUTPUT: %d\n", retVal);
  18:	83 c4 0c             	add    $0xc,%esp
  1b:	50                   	push   %eax
  1c:	68 08 07 00 00       	push   $0x708
  21:	6a 01                	push   $0x1
  23:	e8 b8 03 00 00       	call   3e0 <printf>
    exit();
  28:	e8 56 02 00 00       	call   283 <exit>
  2d:	66 90                	xchg   %ax,%ax
  2f:	90                   	nop
 ...
 3e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 567:	90                   	nop
          s = "(null)";
 568:	ba 1d 07 00 00       	mov    $0x71d,%edx
        while(*s != 0){
