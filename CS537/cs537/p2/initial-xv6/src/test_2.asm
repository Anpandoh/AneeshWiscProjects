...
{    
  ...
  34:	50                   	push   %eax
  35:	68 6f 07 00 00       	push   $0x76f
        argv[0] = "cat";
  3a:	c7 85 f8 fe ff ff 70 	movl   $0x770,-0x108(%ebp)
  41:	07 00 00 
        argv[1] = "README";
  44:	c7 85 fc fe ff ff 68 	movl   $0x768,-0x104(%ebp)
  4b:	07 00 00 
        exec("/cat", argv);
  4e:	e8 c8 02 00 00       	call   31b <exec>
        exit();
  53:	e8 8b 02 00 00       	call   2e3 <exit>
        wait();
  58:	e8 8e 02 00 00       	call   2eb <wait>
        getlastcat(message); //&message[0]
  5d:	8d 9d f8 fe ff ff    	lea    -0x108(%ebp),%ebx
  63:	83 ec 0c             	sub    $0xc,%esp
  66:	53                   	push   %ebx
  67:	e8 17 03 00 00       	call   383 <getlastcat>
        printf(1,"XV6_TEST_OUTPUT Last catted filename: %s\n",message);
  6c:	83 c4 0c             	add    $0xc,%esp
  6f:	53                   	push   %ebx
  70:	68 74 07 00 00       	push   $0x774
  75:	6a 01                	push   $0x1
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba 9e 07 00 00       	mov    $0x79e,%edx
        while(*s != 0){
