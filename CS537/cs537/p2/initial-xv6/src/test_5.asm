...
{    
  ...
  25:	c3                   	ret    
        wait();
  26:	e8 b0 02 00 00       	call   2db <wait>
        int pid = fork();
  2b:	e8 9b 02 00 00       	call   2cb <fork>
        if(pid == 0){
  30:	85 c0                	test   %eax,%eax
  32:	74 2f                	je     63 <main+0x63>
        if(pid > 0) {
  34:	7e e6                	jle    1c <main+0x1c>
            wait();
  36:	e8 a0 02 00 00       	call   2db <wait>
            exit();
  3b:	e8 93 02 00 00       	call   2d3 <exit>
        exec("/cat", argv);
  40:	8d 45 f0             	lea    -0x10(%ebp),%eax
  43:	52                   	push   %edx
  44:	52                   	push   %edx
  45:	50                   	push   %eax
  46:	68 5f 07 00 00       	push   $0x75f
        argv[0] = "cat";
  4b:	c7 45 f0 60 07 00 00 	movl   $0x760,-0x10(%ebp)
        argv[1] = "README";
  52:	c7 45 f4 58 07 00 00 	movl   $0x758,-0xc(%ebp)
        exec("/cat", argv);
  59:	e8 ad 02 00 00       	call   30b <exec>
        exit();
  ...
  68:	50                   	push   %eax
  69:	68 64 07 00 00       	push   $0x764
            argv[0] = "getlastcat";
  6e:	c7 45 f0 65 07 00 00 	movl   $0x765,-0x10(%ebp)
            exec("/getlastcat", argv);
  75:	e8 91 02 00 00       	call   30b <exec>
            exit();
