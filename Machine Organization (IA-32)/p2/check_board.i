     ...
     for (int i = 0; i < size; i++){
      int *row = malloc(sizeof(int)*size);
       for (int j = 0; j < size; j++) {
                         printf("%d  ",(*(*(board+i)+j)));
    if (((*(*(board+i)+j)) != 0) && (*(row+(*(*(board+i)+j))-1) == 1)) {
    printf("%d\n",board[i][j]);
    free(row);
           row=
# 92 "check_board.c" 3 4
              ((void *)0)
# 92 "check_board.c"
                  ;
    return 0;
...
# 134 "check_board.c"
   ...
   int **board = malloc(sizeof(int*)*size);
    ...
    char *line = 
# 151 "check_board.c" 3 4
                ((void *)0)
# 151 "check_board.c"
                    ;
    size_t len = 0;
    char *token = 
# 153 "check_board.c" 3 4
                 ((void *)0)
# 153 "check_board.c"
                     ;
    for (int i = 0; i < size; i++) {
